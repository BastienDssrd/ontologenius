...
namespace ontologenius {
  ...
  public:
    ...
    template<typename T>
    std::string getName(const T& value, bool use_default = true);
    template<typename T>
    std::vector<std::string> getNames(const T& value, bool use_default = true);
    template<typename T>
    std::vector<std::string> getEveryNames(const T& value, bool use_default = true);

    template<typename T>
    std::unordered_set<T> find(const std::string& value, bool use_default = true);
    template<typename T>
    std::unordered_set<T> findSub(const std::string& value, bool use_default = true);
    template<typename T>
