...
namespace ontologenius {
  ...
  public:
    ...
    template<typename T>
    std::unordered_set<index_t> getDownId(const T& value, int depth = -1);
    template<typename T>
    ...
    template<typename T>
    void getDownSafe(B* branch, std::unordered_set<T>& res, int depth = -1, unsigned int current_depth = 0);
    template<typename T>
    void getUpSafe(B* branch, std::unordered_set<T>& res, int depth = -1, unsigned int current_depth = 0);
    template<typename T>
    void getDown(B* branch, std::unordered_set<T>& res, int depth = -1, unsigned int current_depth = 0);
    template<typename T>
    void getUp(B* branch, std::unordered_set<T>& res, int depth = -1, unsigned int current_depth = 0);
    ...
    template<typename T>
    std::unordered_set<T> getDisjoint(const T& value);
